...
If you try to connect to API with your React app To make it possible for your future React app to communicate with the API, you may see an error like this:
...
Add CORS support to our backend:
